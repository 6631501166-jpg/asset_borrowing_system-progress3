...
class _LecturerLoginScreenState extends State<LecturerLoginScreen> {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: _boxedField(
                          ...
                          // keep signature but we validate outside
                          validator: null,
                        ),
                      ),
  ...
  Widget _boxedField({
    ...
    String? Function(String?)? validator, // kept for signature; not used
        ...
        children: [
          ...
          Expanded(
            child: TextFormField(
              ...
              // IMPORTANT: no inline validator; errors are shown outside
